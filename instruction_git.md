...
Ветвления в git нужны для того, чтобы можно было распараллеливать работу над файлом, а также для того, чтобы можно было выполнять черновые изменения, не внося их в основную версию во избежание ее порчи
