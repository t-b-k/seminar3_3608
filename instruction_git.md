...
При вливании ветки в родительскую возможны конфликты, связанные с тем, что какая-то информация в этих двух ветках была отредактирована параллельно и изложена по-разному. 
