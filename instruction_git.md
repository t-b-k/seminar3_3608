...
отображает текущее состояние рабочего каталога и увидеть файлы, которые не отслеживаются Git, а также увидеть, какие у нас созданы ветки, и где по отношению к ним располагается текущая.