...
При вливании ветки в родительскую возможны конфликты, связанные с тем, что какая информация в этих двух ветках была отредактирована параллельно, и отличается. 
